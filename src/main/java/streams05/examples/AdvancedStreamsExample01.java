...
public class AdvancedStreamsExample01 {
    ...
    public static void main(String[] args) {
        ...
        A UUID represents a 128-bit long value that is unique to all practical purpose.
        It is used to identify information in the computer system.
        The UUID class belongs to java. util package.
        Java UUID is made up of hex digit along with four hyphens (-).
        It is 36 characters long unique number, including four hyphens.
         A UUID may be nil, in which all bits are set to zero.
         */
